...
use crate::state::{Action, TokenBridgeMessage, TransferInfo, TransferWithPayloadInfo};
...
fn deserialize_transfer_with_payload_vaa() -> StdResult<()> {
    ...
    // │ Amount: 1.0                                                                  │
    // │ Token: paloma1qqqqqqqqqqqqqqqqqqqqqqqqqp6h2umyswfh6y (Paloma)                │
    // │ Recipient: paloma13nkgqrfymug724h8pprpexqj9h629sa3ncw7sh (Paloma)            │
