...
/// An override of [`QueryRequest::Custom`] to access Paloma-specific modules.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
#[serde(rename_all = "snake_case")]
pub struct PalomaQueryWrapper {
    pub route: PalomaRoute,
    pub query_data: PalomaQuery,
}

impl CustomQuery for PalomaQueryWrapper {}

/// Defines available queries.
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
#[serde(rename_all = "snake_case")]
pub enum PalomaQuery {
    Swap {
        offer_coin: Coin,
        ask_denom: String,
    },
